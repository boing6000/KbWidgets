...
var IpWidget_KbVideo = function () {

    this.widgetObject = null;
    this.modalId = '#ipWidgetVideoPopup .ipsModal';
    ...
    this.onSave = function(obj){
        $(this).kbVideo('update', obj);
    };
    ...
    var openPopup = function () {
        ...
        $(this.modalId).remove(); //remove any existing popup. This could happen if other widget is in management state right now.
    ...
    var save = function (e, response) {
        this.widgetObject.save(response.data.data, 1, this.onSave); // save and reload widget
